...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var quorumjs, Web3, web3, WRAPPER_CONTRACT_ADDR, NATIVE_ABI, nativeContractAddress, nativeContract, fromAccount, approve_amount, approveCode, nonce, PRIVATE_KEY;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    ;
                    nativeContractAddress = "0x0000000000000000000000000000000000000103" // OK
                    ;
                    ...
                    ;
                    approve_amount = web3.utils.toWei('2.01', 'ether');
