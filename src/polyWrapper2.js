...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var Web3, Tx, Ont, web3, CONTRACT_ADDR, ABI, PRIVATE_KEY, account, contract, method, code, nonce;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    web3 = new Web3(new Web3.providers.HttpProvider("http://18.220.17.201:2200"));
                    quorumjs.extend(web3);
                    CONTRACT_ADDR = "0x0c5c0b03e897e7b1828f2bc923ea4498ec891060" // Wrapper contract on Ropsten
                    ;
                    ABI = [
                        {
                            "inputs": [
                    ...
                    account = "0x231d51dbeC6E3E63Ad22078C73B70fBfD1b14265";
                    contract = new web3.eth.Contract(ABI, CONTRACT_ADDR);
                    method = contract.methods.lock("0x0000000000000000000000000000000000000103", 2, account, web3.utils.toWei("0.0001", "ether"), web3.utils.toWei("0.0001", "ether"), 0);
