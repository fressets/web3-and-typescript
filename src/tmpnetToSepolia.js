...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var NATIVE_ABI, WRAPPER_ABI, parameter, PRIVATE_KEY, common, Web3, web3, wrapperContract, amount2, fee, n, _nonce, nativeContractAddress, nativeContract, approve_amount, approveCode, txParams, tx, serializedTx, lockCode, txParams, tx, serializedTx, _;
            ...
            switch (_a.label) {
                case 0:
                    ...
                    parameter = {
                        ...
                        "withLock": false,
                        "approveAmount": "2.01",
                        "endpoint": "http://100.20.221.48:22000",
                        "nativeContractAddress": "0x0000000000000000000000000000000000000103",
                        "WRAPPER_CONTRACT_ADDR": "0xdF539255E823b9D08aAD0b7D7b89868246f65B5a",
                        "WRAPPER_ABI": WRAPPER_ABI,
                        "sepoliaChainId": 602,
                        "pltFromAddress": "0xCD985714a3A3c764dFE2c14f5B8a2480De3F3Bb4",
                        "sepoliaToAddress": "0xA0b06BF06b3Df01E5a18ED72e35c5d4A898E2B3f"
                    };
                    PRIVATE_KEY = Buffer.from("f22585c397340c73a05253897bc442d966e394ad77c3e085c2efdcf67186f11d", "hex");
                    ...
                    Web3 = require("web3");
                    web3 = new Web3(new Web3.providers.HttpProvider(parameter.endpoint));
                    quorumjs.extend(web3);
                    wrapperContract = new web3.eth.Contract(WRAPPER_ABI, parameter.WRAPPER_CONTRACT_ADDR);
                    amount2 = web3.utils.toWei('0.001', 'ether');
                    fee = web3.utils.toWei('0.0001', 'ether');
                    return [4 /*yield*/, web3.eth.getTransactionCount(parameter.pltFromAddress, 'pending')];
                case 1:
                    n = _a.sent();
                    console.log("n: " + n);
                    return [4 /*yield*/, web3.eth.getTransactionCount(parameter.pltFromAddress)];
                case 2:
                    _nonce = _a.sent();
                    console.log("Nonce: " + _nonce);
                    nativeContractAddress = parameter.nativeContractAddress;
                    nativeContract = new web3.eth.Contract(NATIVE_ABI, nativeContractAddress);
                    if (!parameter.withApprove) return [3 /*break*/, 5];
                    approve_amount = web3.utils.toWei(parameter.approveAmount, 'ether');
                    return [4 /*yield*/, nativeContract.methods.approve(parameter.WRAPPER_CONTRACT_ADDR, approve_amount).encodeABI()];
                case 3:
                    approveCode = _a.sent();
                    txParams = {
                        nonce: _nonce + 1,
                    ...
                    tx = new tx_1.Transaction(txParams).sign(PRIVATE_KEY);
                    console.log("sign done.");
                    console.log(tx.toJSON());
                    serializedTx = tx.serialize();
                    console.log("approve sendSignedTransaction: 0x" + serializedTx.toString('hex'));
                    return [4 /*yield*/, web3.eth.sendSignedTransaction('0x' + serializedTx.toString('hex')).then(function (a) {
                ...
                case 4:
                    _a.sent();
                    _a.label = 5;
                case 5: return [4 /*yield*/, web3.eth.getTransactionCount(parameter.pltFromAddress)];
                case 6:
                    // get nonce
                    _nonce = _a.sent();
                    console.log("Nonce: " + _nonce);
                    if (!parameter.withLock) return [3 /*break*/, 9];
                    return [4 /*yield*/, wrapperContract.methods.lock("0x0000000000000000000000000000000000000103", parameter.sepoliaChainId, parameter.sepoliaToAddress, amount2, fee, 0).encodeABI()];
                case 7:
                    lockCode = _a.sent();
                    ...
                    return [4 /*yield*/, web3.eth.sendSignedTransaction('0x' + serializedTx.toString('hex')).on('receipt', function (receipt) {
